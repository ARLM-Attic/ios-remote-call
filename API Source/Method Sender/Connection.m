...
+ (NSString *) baseAddress
{
	...
	NSMutableString *base = [NSMutableString stringWithString:@"http://5.175.235.79:50010/iOSRemoteConnector/"];
...
- (void) sendWithMethod:(NSString *)method usingVerb: (NSString *) verb andParameters:(NSArray *)parameters
{
	...
	NSMutableString *sendAddress = [NSMutableString stringWithString:[Connection baseAddress]];
...
- (void) uploadMultipartData:(NSData *)data withName:(NSString *) name ofType:(NSString *) fileType
{
	...
	NSMutableString *base = [NSMutableString stringWithString:@"http://5.175.235.79/WcfRestService4/Service1/iphone/upload/"];
